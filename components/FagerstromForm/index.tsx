...
const FarForm = (props: any) => {
  return (
    <div
      className={styles.screenContainer}
      style={
        props.page == "fagerstrom_test"
          ? { display: "block" }
          : { display: "none" }
      }
    >
      <div className={styles.container}>
        <div className={styles.titleContainer}>Teste de Fagerström</div>
        <div className={styles.subtitleContainer}>
          O Teste de Fagerström mede o grau de dependência à nicotina. Todo
          paciente deve ter aferido o seu grau de <br />
          dependência à nicotina, considerando que é essa dependência que
          dificulta o processo de abstinência, pois <br />
          causa sintomas desconfortáveis nas pessoas que tentam parar de fumar,
          e aumenta as chances de as pessoas <br />
          voltarem a fumar.
        </div>
